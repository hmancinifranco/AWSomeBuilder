...
def process_message(message_body, table):
    ...
    logger.info(f'Starting Comprehend Classification job {job_name} with model {CLASSIFIER_ARN}')
    ...
    try:
        if 'Records' in event:  # This is an SQS trigger event
            ...
            for record in event['Records']:
                ...
                logger.info(f"Deleted message from SQS queue: {message_body}")
            ...
            logger.info("Received a manual invocation or test event")
